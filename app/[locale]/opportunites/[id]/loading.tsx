    ...
    <div className="container-shell space-y-8 py-10">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.5fr_0.8fr]">
        <div className="space-y-6">
          <div className="animate-pulse rounded-3xl bg-neutral-300 px-8 py-10 space-y-4">
            <div className="h-3 w-24 rounded bg-neutral-400" />
            <div className="h-10 w-2/3 rounded bg-neutral-400" />
            <div className="h-4 w-full rounded bg-neutral-400/70" />
            <div className="h-4 w-5/6 rounded bg-neutral-400/70" />
          </div>
